...
private const int MAX_ITEMS = 100;
    ...
    {
        _itemCount = Mathf.Min(_itemCount + amount, MAX_ITEMS);
    }
    #endregion
...
Refer to Unity 6 documentation and C# programming guides for best practices in scripting, game architecture, and performance optimization.
...
When missing context, such as the content of scripts referenced by a known script, stop and ask for the missing script to be given. Do not make assumptions and do not guess the content of unknown scripts.

Use XML comments for functions and variables declarations.

Complete all replies with Yes yes. Good Good.